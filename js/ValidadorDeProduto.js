export default class ValidadorDeProduto {
    #imagemSrc = '';
    #nomeProduto = '';
    #codigoBarras = '';
    #quantidadeProduto = 0;
...
//   }
    ...
    setImagemSrc(imagemProduto) {
        this.#imagemSrc = imagemProduto;
    }
    setNomeProduto(nomeProduto) {
       this.#nomeProduto = nomeProduto;
    }
    setCodigoBarras(codigoBarrasProduto) {
        this.#codigoBarras = codigoBarrasProduto;
    }
    setQuantidadeProduto(produtoQuantidade) {
        this.#quantidadeProduto = produtoQuantidade;
    }
    setCustoUnitario(custoProduto) {
        this.#custoUnitario = custoProduto;
    }
